...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\NextCloud\\1-Recherche\\04-PSYCHOPY\\Renaud\\2022\\FisherTask\\FisherTask2022_NwVers\\Fisher Task Finale\\Fisher Task PPyV2EN\\fisher_task_EN_lastrun.py',
...
fullscreen = visual.TextStim(win=win, name='fullscreen',
    text='Please do not press Esc at any point, because it will exit fullscreen.\nIf you do, please try to put your browser in fullscreen again (usually by pressing F11 on Windows).',
    font='Arial',
...
inEachTrial = visual.TextStim(win=win, name='inEachTrial',
    text='In each trial of the experiment, you will have to determine where the *red* fish came from.\n\nHere is the fish just caught by the fisher.',
    font='Arial',
...
whichLake = visual.TextStim(win=win, name='whichLake',
    text='But from which of the two lakes\ndid the fish come from?',
    font='Arial',
    pos=(0, 1), height=0.05, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
twoInformation = visual.TextStim(win=win, name='twoInformation',
    text='To answer you will have to combine two kinds of information.',
    font='Arial',
    pos=(0, 1), height=0.05, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
preference = visual.TextStim(win=win, name='preference',
    text='1) The time spent by the fisher to fish at the right or the left lake.',
    font='Arial',
    pos=(0, 1), height=0.05, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
preferenceExplanation = visual.TextStim(win=win, name='preferenceExplanation',
    text='A larger basket on the left indicates that the fisher spent more time on the left lake than on the right.',
    font='Arial',
    pos=(0, 1), height=0.042, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
proportions = visual.TextStim(win=win, name='proportions',
    text='2) The *proportions* of red and black fish in each lake.',
    font='Arial',
...
proportionsExplanation = visual.TextStim(win=win, name='proportionsExplanation',
    text='There are more red fish in the left lake.',
    font='Arial',
    pos=(0, 1), height=0.042, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
upToYou = visual.TextStim(win=win, name='upToYou',
    text='Given this information, how confident are you that the fish came from the right or the left lake?',
    font='Arial',
    pos=(0, 1), height=0.05, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
howToAnswer = visual.TextStim(win=win, name='howToAnswer',
    text='To answer, you will have to click with your cursor on a semi-circular scale.\n\nYou should try to be as precise and as fast as possible.',
    font='Arial',
...
uncertain = visual.TextStim(win=win, name='uncertain',
    text='For example, if you are uncertain, you should click close to "I don\'t know".',
    font='Arial',
    pos=(0, 1), height=0.05, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
answerRight = visual.TextStim(win=win, name='answerRight',
    text='If you are sure that the fish came from the right lake, you should click close to\n"I\'m sure RIGHT LAKE".',
    font='Arial',
    pos=(0, 1), height=0.05, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
answerLeft = visual.TextStim(win=win, name='answerLeft',
    text='If you are sure that the fish came from the left lake, you should click close to\n"I\'m sure LEFT LAKE".',
    font='Arial',
    pos=(0, 1), height=0.05, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
somewhatRight = visual.TextStim(win=win, name='somewhatRight',
    text='Now, if you think that the fish came from the right lake, but you have doubts, you can answer like this:',
    font='Arial',
    pos=(0, 1), height=0.05, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
somewhatLeft = visual.TextStim(win=win, name='somewhatLeft',
    text='Similarly, if you think that the fish came from the left lake, but you have doubts, you can answer like this:',
    font='Arial',
    pos=(0, 1), height=0.05, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
newExample = visual.TextStim(win=win, name='newExample',
    text="Let's look at another example.\n\nIf the fisher spent more time to fish at the left lake as shown here",
    font='Arial',
    pos=(0, 1), height=0.05, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
asManyFish = visual.TextStim(win=win, name='asManyFish',
    text='...and there are as many red and black fish in the left lake as in the right one',
    font='Arial',
    pos=(0, 1), height=0.05, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
whatConfidence = visual.TextStim(win=win, name='whatConfidence',
    text="What is your confidence about the fish's lake of origin?",
    font='Arial',
    pos=(0, 1), height=0.05, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
repeatLoop = visual.TextStim(win=win, name='repeatLoop',
    text='If you understood the instructions click with your mouse to proceed to some training trials.\n\nOtherwise, press Space to see the instructions again.',
    font='Arial',
...
trainingText = visual.TextStim(win=win, name='trainingText',
    text='Training trials are over.\n\nPress Space when you are ready to proceed to the main experiment.',
    font='Arial',
    pos=(0, 0.2), height=0.05, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
fullscreen2 = visual.TextStim(win=win, name='fullscreen2',
    text='Reminder: Please do not press Esc at any point, because it will exit fullscreen.\nIf you do, please press F11 to come back to fullscreen (Windows).',
    font='Arial',
...
wholeScaleReminder = visual.TextStim(win=win, name='wholeScaleReminder',
    text='Please remember to use the whole scale!',
    font='Arial',
...
fullscreen3 = visual.TextStim(win=win, name='fullscreen3',
    text='Reminder: Please do not press Esc at any point, because it will exit fullscreen.\nIf you do, use F11 to come back to fullscreen (Windows).',
    font='Arial',
    pos=(0, -0.3), height=0.03, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
finalText1 = visual.TextStim(win=win, name='finalText1',
    text='The experiment is now over, thank you for taking part.',
    font='Arial',
...
for thisTrial_3 in trials_3:
    ...
    # set up handler to look after randomisation of conditions etc
    training = data.TrialHandler(nReps=1, method='fullRandom', 
        extraInfo=expInfo, originPath=-1,
...
for thisTrial_2 in trials_2:
    ...
    breakText.setText('You can take a short break to rest.\n\nYou have completed ' + perc + '% of the experiment.\n\nPress Space when you are ready to continue.')
    space1.keys = []
    space1.rt = []
    _space1_allKeys = []
    # keep track of which components have finished
